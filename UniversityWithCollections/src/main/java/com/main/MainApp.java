...
public class MainApp {
	public static void main(String[] args) {
		...
		Student student1 = new Student(11, "Saivarun", 22);
		Student student2 = new Student(12, "John", 23);
		Student student3 = new Student(13, "Mike", 24);
		Student student4 = new Student(14, "Robert", 25);
		Student student5 = new Student(15, "Kevin", 26);

		Student student6 = new Student(16, "Varun", 22);
		Student student7 = new Student(17, "Sai", 23);
		Student student8 = new Student(18, "Kevin", 24);
		Student student9 = new Student(19, "Mike", 25);
		Student student10 = new Student(20, "Robert", 26);
		...
		Department department3 = new Department(201, "MECH", students);
		Department department4 = new Department(202, "CIVIL", students);
		...
		College college1 = new College(1001, "CVR", departments);
		College college2 = new College(1002, "CBIT", departments);
